...
export default function SectionHeader({ Icon, title, description, section }: SectionHeaderProps) {
    ...
    return (
        <div className="w-full max-w-lg flex flex-col items-center justify-center gap-4">
            {(Icon && section) && <div
                className="w-fit py-2 px-4 rounded-full border-t shadow-xl shadow-blue-500/50 float-animation flex items-center justify-center gap-2 bg-white/60 backdrop-blur-md border-2 border-blue-200">
