...
export default function CTA() {
    return (
        <section className="w-full py-24 flex items-center justify-center">
            <div className="w-full max-w-5xl rounded-2xl py-16 bg-white/30 backdrop-blur-md border-2 border-blue-200/80 shadow-xl shadow-blue-500/30 overflow-hidden">
                <div className="w-full flex flex-col items-center justify-center gap-6 z-[100] relative">
                    ...
                    <Link href={{
                        pathname: "/signin",
                        query: "type=signin"
                    }} className="py-2 px-5 text-lg bg-gradient-to-tl from-blue-800 via-blue-600 to-blue-400 text-white font-medium rounded-xl shadow-xl shadow-blue-500/50 hover:from-blue-400 hover:to-blue-800 hover:bg-gradient-to-b duration-200 ease-in-out transition-all">
                        Get Started
                    </Link>
                </div>
...
function Ripple() {
    return (
        <div className="relative left-[50%] bottom-[100px] scale-110 rotate-90">
            <div className="w-[800px] h-[800px] rounded-full shadow-xl shadow-blue-500/30 bg-white absolute z-10 top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2"></div>
