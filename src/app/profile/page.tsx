...
export default function ProfilePage() {
    ...
    return (
        <div className="w-full min-h-screen flex justify-center py-12 md:py-16 mt-20">
                ...
                <div className="personal-info-cards w-full flex flex-col gap-5">
                    <div className="w-full flex items-center justify-between">
                        ...
                        <button onClick={handleNameChange}
                            className={hasNameChanged ? "cta-btn cursor-pointer" : "cta-btn-disabled"}
                ...
                <div className="personal-info-cards w-full flex flex-col lg:flex-row lg:justify-between gap-8">
                    ...
                    <main className="w-full lg:w-2/3 p-0 sm:p-0">
                        <div className="flex flex-col gap-8">
                            ...
                            <div className="w-full rounded-xl p-6 bg-blue-50 backdrop-blur-md border-2 border-blue-200">
                                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                                    <div>
                                        <h3 className="text-lg font-semibold text-blue-600">Free Plan</h3>
                                        <p className="text-blue-500/80 text-sm">No active subscription</p>
                                    </div>
                            ...
                            <div className="w-full rounded-xl p-6 bg-blue-50 backdrop-blur-md border-2 border-blue-200">
                                ...
                                <div className="flex items-center justify-between mb-2">
                                    ...
                                    <p className="text-sm text-blue-500/80">0 / 3</p>
                                </div>
                                <Progress value={0}/>
                            </div>
